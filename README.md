Phishing Email Analysis 🛡️
  ...
  This project documents the analysis of phishing emails to uncover common threat indicators, spoofing techniques, and malicious links. The goal was to identify phishing attempts using 
  manual inspection and threat intelligence tools, and to report on the findings in a structured format.
